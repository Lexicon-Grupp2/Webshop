        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            */
            ...
            modelBuilder.Entity<ProductImage>().HasData(new List<ProductImage>
            {
                ...
                new ProductImage
                    {ImageId = 7, ImageTitle = "Forest fruit", ImageName = "chokladbild.jpg", ImageThumbName = "chokladbildth.jpg"},
                new ProductImage
            ...
            modelBuilder.Entity<Product>().HasData(new List<Product>
            {
                ...
                new Product
                    {Id = 1004, Name = "Peanut butter cup-cake", Description="Filled with peanut butter and topped with delicious peanut frosting.", CategoryId = 104, Price = 34, ProductImageId = 4},
                new Product
                ...
                new Product
                    {Id = 1007, Name = "Forest fruit", Description="Not the tea, instead a cupcake with every kind of berry.", CategoryId = 104, Price = 34, ProductImageId = 7},
                new Product
                ...
                new Product
                    {Id = 1009, Name = "Lemon", Description="If you like something with a fresher taste, this cupcake is for you.", CategoryId = 104, Price = 34, ProductImageId = 9},
                new Product
                    {Id = 1010, Name = "Taste the rainbow", Description="Every taste of the fruit rainbow you can imagine.", CategoryId = 104, Price = 34, ProductImageId = 10},     
            });
